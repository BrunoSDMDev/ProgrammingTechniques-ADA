...
public class Classroom {
    ...
    public static void main(String[] args) throws IOException {
        Path path = Path.of("E:\\JAVA\\Tecnicas-Programacao\\FunctionalProgramming-ADA\\ProgrammingTechniques-ADA\\resources\\test.txt");
        ...
        File file = new File("E:\\JAVA\\Tecnicas-Programacao\\FunctionalProgramming-ADA\\ProgrammingTechniques-ADA\\resources/test-mkdir");
...
//        Files.copy(file.toPath(), Path.of("E:\\JAVA\\Tecnicas-Programacao\\FunctionalProgramming-ADA\\ProgrammingTechniques-ADA\\resources/test-mkdir-copy"));


        // Mover arquivo/diretório
        // move(Path source, Path target, CopyOption... options)
//        Path pathFile = Path.of("E:\\JAVA\\Tecnicas-Programacao\\FunctionalProgramming-ADA\\ProgrammingTechniques-ADA\\resources\\move.txt");
//        Path pathDir = Path.of("E:\\JAVA\\Tecnicas-Programacao\\FunctionalProgramming-ADA\\ProgrammingTechniques-ADA\\resources\\test-mkdir\\files/move.txt");
//        Files.move(pathDir, pathFile);
        ...
        Files.delete(Path.of("src/main/resources/move2.txt"));
    }
}
