...
//        Path path = Paths.get("src/main/resources/aula7/payment.txt");
//        if (!Files.exists(path)) Files.createFile(path);
//
//        Payment payment = new Payment(1L, 0L, 10L, "BRL");
//
//        try (FileChannel channel = FileChannel.open(path, StandardOpenOption.WRITE);
//             ObjectOutputStream objectOutputStream = new ObjectOutputStream(Channels.newOutputStream(channel))) {
//            objectOutputStream.writeObject(payment);
//        } catch (NotSerializableException ex) {
//            System.out.println("Objeto não serializável :(");
//        }
...
//             ObjectInputStream objectInputStream = new ObjectInputStream(Channels.newInputStream(channel))) {
//            var object = objectInputStream.readObject();
//            if (object instanceof Payment p) System.out.println(p);
//        } catch (NotSerializableException ex) {
//            System.out.println("Objeto não serializável :(");
