...
public class Async {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        ExecutorService executorService = Executors.newSingleThreadExecutor(); // executorService é reutilizável em
        ...
        Future<?> future = executorService.submit(runnable1); // Container de objeto (Como o Optional)
        while (!future.isDone()) {
