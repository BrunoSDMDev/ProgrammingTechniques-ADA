...
public class Parallelism {
    ...
    public static void main(String[] args) {
         ...
         * Ex: garbage collector - Limpa a memória, apagando os processos que não serão mais utilizados
         */
        ...
        // daemon - Os processos que não são explícitos mas rodam em background auxiliando o desempenho de outros processos
...
//    // Quando duas ou mais treads distribuem locks entre elas enquanto há a execução, impossibilitando suas conclusões.
//
